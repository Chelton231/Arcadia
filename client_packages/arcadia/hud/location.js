...
mp.events.add("render", () => {
    if (streetName && zoneName) {
        drawText(streetName, [minimap.rightX + 0.01, minimap.bottomY - 0.065], 4, [255, 255, 255, 255], 0.45);
        drawText(zoneName, [minimap.rightX + 0.01, minimap.bottomY - 0.035], 4, [255, 255, 255, 255], 0.4);
    ...
    let rot = mp.players.local.getRotation(5);
    let playerPos = "X: " + pos.x.toFixed(4) + "    Y:" + pos.y.toFixed(4) + "    Z: " + pos.z.toFixed(4);
    let playerRot = "X: " + rot.x.toFixed(4) + "    Y:" + rot.y.toFixed(4) + "    Z: " + rot.z.toFixed(4);
    drawText(playerPos, [minimap.leftX + 0, minimap.topY - 0.065], 4, [255, 255, 255, 255], 0.35);
    drawText(playerRot, [minimap.leftX + 0, minimap.topY - 0.085], 4, [255, 255, 255, 255], 0.35);
});