...
class Camera {
    ...
    constructor(identifier, position, pointAtCoord, fov) {
    ...
    create() {
        ...
        this.camera = mp.cameras.new(this.identifier, this.position, new mp.Vector3(0, 0, 0), this.fov);
